...
import { WorkShiftService } from '@/lib/service';
import { useRouter } from 'next/navigation';
import { useEffect, useState } from 'react';
import toast from 'react-hot-toast';
import AddorEditWorkShift from './AddorEditWorkShift';

export default function WorkShiftActionDropDown({
  theme,
}: {
  theme?: IThemes;
}) {
  ...
  const handleConfirm = async () => {
    ...
    const response = await WorkShiftService.deleteShift(currentTheme.id);
