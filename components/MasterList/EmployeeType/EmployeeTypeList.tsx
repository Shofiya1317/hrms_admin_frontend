...
import EmployeeTypeActionDropDown from './EmployeeTypeActionDropDown';

function EmployeeType({ module }: { module: IThemes }) {
  return (
    <Stack>
      <div className="my-2">
        ...
        >
          ...
          <Accordion.Body>
            <div className="row">
              ...
              <div className="col-2">
                <EmployeeTypeActionDropDown theme={module} />
              </div>
            </div>
          </Accordion.Body>
        </Accordion.Item>
